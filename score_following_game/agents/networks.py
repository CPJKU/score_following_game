...
class ScoreFollowingNetMSMDLCHSDeepDoLight(nn.Module):
    def __init__(self,  n_actions, spec_channels, sheet_channels):
        ...
        # spec part
        self.spec_conv1 = nn.Conv2d(spec_channels, out_channels=16, kernel_size=3, stride=1, padding=0)
        ...
        # sheet part
        self.sheet_conv1 = nn.Conv2d(sheet_channels, out_channels=16, kernel_size=5, stride=(1, 2), padding=0)
